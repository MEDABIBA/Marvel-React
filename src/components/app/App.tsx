...
import SignleCharacter from "../pages/SingleCharacter/SingleCharacter"
 ...
 const Appp = (): JSX.Element =>{
    ...
    return(   
        ...
        <Routes>
               ...
               <Route path="/characters/:ID" element={<SinglePage Component={SignleCharacter} dataType="character"/>} />
