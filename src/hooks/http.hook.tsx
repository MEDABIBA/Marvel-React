...
export const useHttp =  ()=>{ 
    ...
    const request: (url: string, method?:'GET'|'POST', body?: string|null, headers?: IrequestHeaders) => Promise<any> = useCallback(async (url, method = 'GET', body = null, headers = {'Content-type': 'application/json'})=> {
        setLoading(true);
        setProcess('loading')
            try{
